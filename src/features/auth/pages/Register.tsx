...
const RegisterPage = () => {
  ...
  const signIn = async (data: RegisterFormType) => {
    await withAsyncHandler(() => register(data), {
      onSuccess: (res) => {
      ...
      <div className="w-full max-w-sm">
        <Card className="">
          ...
          <CardContent>
            ...
            >
              <FieldGroup>
                <registerFormInstance.Field name="name">
                  {(field) => {
                    const isInvalid =
                ...
                <registerFormInstance.Field name="email">
                  {(field) => {
                    const isInvalid =
                      field.state.meta.isTouched && !field.state.meta.isValid;
                    return (
                ...
                <registerFormInstance.Field name="password">
                  {(field) => {
                    const isInvalid =
                      field.state.meta.isTouched && !field.state.meta.isValid;
                    return (
                ...
                <registerFormInstance.Field name="confirmPassword">
                  {(field) => {
                    const isInvalid =
                      field.state.meta.isTouched && !field.state.meta.isValid;
                    return (
          ...
          <CardFooter className="flex-col gap-2">
            ...
            <div className="text-muted-foreground text-sm">
              ...
              <Link to={ROUTES.LOGIN} className="ms-2 underline">
                Sign In
              </Link>
            </div>
          </CardFooter>
