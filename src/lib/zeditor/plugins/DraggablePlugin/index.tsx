...
import {
    ...
    getBaseOptions,
    getDynamicOptions,
} from '@/lib/zeditor/plugins/ComponentPickerPlugin';
import { useModal } from '@/lib/zeditor/hooks';
...
export default function DraggableBlockPlugin({
    ...
    useEffect(() => {
        if (isPickerOpen && searchInputRef.current) searchInputRef.current.focus();
    }, [isPickerOpen]);
    ...
    const selectOption = useCallback(
        (option: ComponentPickerOption) => {
            ...
            editor.update(() => {
                ...
                if (pickerState.insertBefore) node.insertBefore(placeholder);
