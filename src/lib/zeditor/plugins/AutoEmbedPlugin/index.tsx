...
import Button from '@/lib/zeditor/ui/Button';
import { DialogActions } from '@/lib/zeditor/ui/Dialog';
import { INSERT_FIGMA_COMMAND, INSERT_TWEET_COMMAND, INSERT_YOUTUBE_COMMAND } from '@/lib/zeditor/plugins';
...
export default function AutoEmbedPlugin(): JSX.Element {
  ...
  const openEmbedModal = (embedConfig: PlaygroundEmbedConfig) => {
    showModal({
      ...
      content: <AutoEmbedDialog embedConfig={embedConfig} />,
      onSubmit: () => { }
    })
  };
